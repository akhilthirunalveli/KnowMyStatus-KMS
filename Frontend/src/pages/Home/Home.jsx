    ...
    <div className="min-h-screen bg-app-background subtle-grid">
      <nav className="fixed top-6 left-0 right-0 z-50 flex justify-center px-4">
        <div className="premium-card w-full max-w-5xl !rounded-full px-6 py-3 flex items-center justify-between">
          <Link to="/" className="text-2xl font-bold text-white tracking-tight hover:opacity-80 transition-opacity flex items-center gap-1 cabinet-grotesk">
      ...
      {/* Main Content */}
      <div className="w-full h-screen relative pt-32 overflow-hidden">
