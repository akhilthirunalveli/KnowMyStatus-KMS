    ...
    <div className="h-screen w-full bg-black cabinet-grotesk overflow-hidden flex flex-col relative">
      ...
      <div className="flex-1 grid grid-cols-1 lg:grid-cols-2 h-full">
        ...
        <div className="bg-[#050505] border-r border-white/10 relative z-10 h-full overflow-y-auto custom-scrollbar">
          ...
          <div className="w-full max-w-md mx-auto min-h-full flex flex-col justify-center px-8 sm:px-12 py-16">
            <div className="mb-8">
              <h1 className="text-4xl font-bold text-white mb-2 tracking-tight">Create Account</h1>
              <p className="text-gray-400">Join us to manage your status efficiently.</p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div className="space-y-1.5">
                ...
                <div className="relative group">
                  <User className="absolute left-0 top-3.5 text-gray-600 group-focus-within:text-white transition-colors" size={18} />
                  <input
                    name="name"
                    type="text"
                    value={formData.name}
              ...
              <div className="grid grid-cols-2 gap-5">
                <div className="space-y-1.5">
                  ...
                  <div className="relative group">
                    <BookOpen className="absolute left-0 top-3.5 text-gray-600 group-focus-within:text-white transition-colors" size={18} />
                    <input
                      name="subject"
                      type="text"
                ...
                <div className="space-y-1.5">
                  ...
                  <div className="relative group">
                    <Building className="absolute left-0 top-3.5 text-gray-600 group-focus-within:text-white transition-colors" size={18} />
                    <input
                      name="department"
                      type="text"
              ...
              <div className="space-y-1.5">
                <label className="text-xs font-medium text-gray-400 uppercase tracking-wider">Office (Optional)</label>
                <input
                  name="office"
                  type="text"
                  value={formData.office}
                  onChange={handleChange}
                  className="w-full bg-transparent border-b border-white/10 py-3.5 text-white focus:border-[#ff3333] transition-colors outline-none placeholder-gray-700 rounded-none text-sm"
