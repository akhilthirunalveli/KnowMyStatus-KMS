  ...
  return (
    <div className="h-screen w-full bg-black cabinet-grotesk overflow-hidden flex flex-col relative">
      ...
      <div className="flex-1 grid grid-cols-1 lg:grid-cols-2 h-full">
        ...
        {/* Left Side: Form */}
        <div className="flex flex-col justify-start px-8 sm:px-12 lg:px-20 xl:px-32 bg-[#050505] border-r border-white/10 relative z-10 h-full overflow-y-auto pt-24 sm:pt-32">
